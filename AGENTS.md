# Deucarian Object Selection Core State Integration Agent Notes

Package ID: `com.deucarian.object-selection.core-state-integration`
Repository: `Deucarian/ObjectSelection-CoreState-Integration`
...
- sync adapter behavior between world selection and repository state.

This package must not own:

- Own independent framework behavior outside the Object Selection and Core State adapter boundary.
...
- May depend only on declared target packages and small infrastructure packages it directly uses. Current target boundary: Object Selection and Core State.
